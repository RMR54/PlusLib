...
void vtkPlusWinProbeVideoSource::SetRfEnabled(bool value)
{
  if(Connected)
  {
    if(value)
...
bool vtkPlusWinProbeVideoSource::GetRfEnabled()
{
  bool rfEnabled = (m_Mode == Mode::BRF);
  if(Connected)
  {
    rfEnabled = (GetBFRFImageCaptureMode() == 2);
    if(rfEnabled)
    {
      m_Mode = Mode::BRF;
    }
